...
[[nodiscard]] auto calculate(const std::vector<Point3D<T>> &points, const T refX, const T refY, const T refZ);
}
...
namespace __hv3d {
template <typename T, class Map>
auto calculate(const std::vector<Point3D<T>> &points, const T refX, const T refY, const T refZ) {
