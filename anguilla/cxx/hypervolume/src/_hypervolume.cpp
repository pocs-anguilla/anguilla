...
PYBIND11_MODULE(_hypervolume, m) {
    ...
    m.def("hv2d_f8", &hv2d::calculate<double>, hv2d::docstring,
          py::arg("ps"), py::arg("ref_p"));

    m.def("hv3d_btree_f8", &hv3d::calculate<double>,
          hv3d::docstring, py::arg("ps"), py::arg("ref_p"));

    m.def("hv3d_rbtree_f8", &hv3d::calculate<double, hv3d::RBTreeMap<double>>,
          hv3d::docstring, py::arg("ps"), py::arg("ref_p"));

    m.def("hvc2d_f8", &hvc2d::contributions<double>, hvc2d::docstring,
          py::arg("ps"), py::arg("ref_p"));

    m.def("hvc3d_btree_f8", &hvc3d::contributions<double>,
