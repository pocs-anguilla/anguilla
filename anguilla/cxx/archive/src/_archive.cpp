...
PYBIND11_MODULE(_archive, m) {
    ...
    py::class_<archive::Archive<f8>>(m, "UPMOArchive")
        ...
        .def_property("size",
                      &archive::Archive<f8>::size,
                      nullptr)
        .def_property("empty",
                      &archive::Archive<f8>::empty,
                      nullptr)
        .def_property("nbytes",
                      &archive::Archive<f8>::nbytes,
                      nullptr)
        .def_property("reference",
                      &archive::Archive<f8>::reference,
                      nullptr,
                      py::return_value_policy::reference)
        .def_property("left_extreme",
                      &archive::Archive<f8>::leftExtremeIndividual,
                      nullptr,
                      py::return_value_policy::reference)
        .def_property("right_extreme",
                      &archive::Archive<f8>::rightExtremeIndividual,
                      nullptr,
                      py::return_value_policy::reference)
        .def("insert",
             &archive::Archive<f8>::insert,
             py::arg("point"),
             py::arg("fitness"),
             py::return_value_policy::reference)
        .def("sample_extreme",
             &archive::Archive<f8>::sampleExtreme,
             py::arg("p"),
             py::return_value_policy::reference)
        .def("sample_interior",
             &archive::Archive<f8>::sampleInterior,
             py::arg("p"),
             py::return_value_policy::reference)
        .def("nearest",
             &archive::Archive<f8>::nearest,
             py::arg("node"),
             py::return_value_policy::reference)
        .def(
            ...
            py::keep_alive<0, 1>())
        .def("get_statistics", &archive::Archive<f8>::getStatistics)
    ...
    py::class_<archive::Individual<f8>>(m, "UPMOIndividual")
        .def(py::init<const py::array_t<f8> &, const py::array_t<f8> &, f8, f8>(),
             ...
             py::arg("p_succ") = 0.5)
        .def_readonly("point",
                      &archive::Individual<f8>::point,
                      py::return_value_policy::reference_internal)
        .def_readonly("fitness",
                      &archive::Individual<f8>::fitness,
                      py::return_value_policy::reference_internal)
        .def_readonly("contribution",
                      &archive::Individual<f8>::contribution)
        .def_readonly("acc_contribution",
                      &archive::Individual<f8>::accContribution)
        .def_readwrite("step_size",
                       &archive::Individual<f8>::step_size)
        .def_readwrite("p_succ",
                       &archive::Individual<f8>::p_succ)
        .def_property("cov",
                      &archive::Individual<f8>::getCov,
                      nullptr)
        .def("coord",
             &archive::Individual<f8>::coord,
             py::arg("index"));

    py::class_<archive::Statistics>(m, "UPMOStatistics")
        .def(py::init<>())
        .def_property("insert_success_ratio",
                      &archive::Statistics::getInsertSucessRatio,
                      nullptr);
    ...
    py::class_<archive::Parameters<f8>>(m, "UPMOParameters")
        ...
        .def_readonly("initial_step_size",
                      &archive::Parameters<f8>::initialStepSize)
        .def_readonly("d",
                      &archive::Parameters<f8>::d)
        .def_readonly("p_target_succ",
                      &archive::Parameters<f8>::pTargetSucc)
        .def_readonly("c_p",
                      &archive::Parameters<f8>::cP)
        .def_readonly("p_threshold",
                      &archive::Parameters<f8>::pThreshold)
        .def_readonly("c_cov",
                      &archive::Parameters<f8>::cCov)
        .def_readonly("p_extreme",
                      &archive::Parameters<f8>::pExtreme)
        .def_readonly("sigma_min",
                      &archive::Parameters<f8>::sigmaMin)
        .def_readonly("alpha",
                      &archive::Parameters<f8>::alpha)
        .def_readonly("c_r",
                      &archive::Parameters<f8>::cR);
